    ...
    renderTitle() {
        return (
            <View style={styles.titleHeader}>
                ...
                <TouchableOpacity onPress={()=>this.selectYear1(this.state.year)}>
        ...
        return (
            <Modal
                ...
                <View style={{ flex: 1, flexDirection: 'column', justifyContent: 'center', alignItems: 'center', backgroundColor: "rgba(0,0,0,0.8)" }}>
                    <TouchableOpacity activeOpacity={1} style={{flex: 1}} onPress={()=>this.props.onClose()}>
                    <View style={{flex: 1, width: ScreenWidth, backgroundColor: "transparent"}}></View>
                    </TouchableOpacity>
                    <View style={{ width: scale(683), backgroundColor: 'transparent', padding: 8 }}>
