...
export default class CommandIdeaBox extends Component {
  static propTypes = {
                  ...
                  <View style={{ flex: 4.5}}>
                    <View style={{ marginTop: 5, flex: 2 }}>
                        <TextInput
                          style={[
                            styles.border,
                            { marginTop: 5, height: verticalScale(155), padding: 5 }
                          ]}
                          multiline={true}
                          autoCorrect={false}
                          returnKeyType="done"
                    ...
                    <View style={{flex: 1, backgroundColor: "white", borderWidth: 1, borderColor: "#b4b4b4", flexDirection: "row"}}>
                        <View style={{backgroundColor: "white", flex: 2, justifyContent: "center", alignItems: "center"}}>
                          <Image source={require('../../../../assets/images/user-controls/noidungmau1.png')} style={{width: scale(60), height: scale(60)}} />
                        </View>
                        <View style={{backgroundColor: "white", flex: 8, justifyContent: "center",}}>
  ...
  render() {
    return (
      <View>
        <SuccessModal
          content="Gửi ý kiến chỉ đạo thành công"
          ref={ref => {
            this._success = ref;
          }}
        />
