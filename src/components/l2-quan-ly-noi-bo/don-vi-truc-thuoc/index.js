...
export default class DonViTrucThuoc extends Component {
    ...
    constructor(props) {
        super(props);
        this.state = {text: '',
          pageTitle: this.props.navigation.getParam('title') ? this.props.navigation.getParam('title') : GROBAL_RESOUCE.QUAN_LY_DON_VI_TRUC_THUOC_TITLE,
          isLoading: true,
          listData: [],
          defaultlistData: [],
    ...
    componentDidMount() {
        LinhVucQuanLyAPI.getDonVi(3, 0, 100).then((res)=>{
          if(res){
